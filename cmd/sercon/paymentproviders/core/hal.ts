...
// Matches exact, or by hyphen-delimited suffix to tolerate qualified rels like
// "create-paymentorder-capture" (rel "capture" matches "...-capture" but NOT a
// rel like "precancel"). Looks at payload.operations and payload.paymentOrder.operations.
