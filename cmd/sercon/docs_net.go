...
func netDocs() map[string]scriptengine.MemberDoc {
	return map[string]scriptengine.MemberDoc{
		...
		"http.request": {
			Summary: "Full HTTP client: method, url, opts {headers, body|multipart, timeout, retry, follow, username, password, maxBytes}. body is string|Uint8Array|ArrayBuffer; multipart builds a multipart/form-data upload. Returns {status, ok, headers, body, bodyBytes, url}. 4xx/5xx dont throw; retry covers transport errors + 5xx.",
			Params: []scriptengine.Param{
