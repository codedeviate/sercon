...
api.runtime.log("argv:", JSON.stringify(runtime.argv));
api.runtime.log("program:", runtime.argv[0]);
api.runtime.log("script:", runtime.argv[1]);
...
api.runtime.assert.ok(runtime.argv.length >= 2, "argv should hold program + script");
api.runtime.assert.ok(runtime.argv[1].endsWith("argv.ts"), "argv[1] is the running script");
