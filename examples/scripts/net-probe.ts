...
// CI invokes its own offline subset). Self-skips (exit 0) when the network
// is unreachable; genuine errors are re-thrown.
...
try {
  ...
  runtime.log("network unreachable — skipping net-probe demo. (" + String(e).slice(0, 120) + ")");
}
